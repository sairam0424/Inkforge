...
![Feature flag push-based distribution — control plane fans out to all SDK instances](https://media.giphy.com/media/PSmI3u9p9BlibpTS7g/giphy.gif)
*Push-based distribution: every flag change fans out instantly to all service instances*
...
![Kill switch — instant feature shutdown in production](https://media.giphy.com/media/2eV7JJr1HXqseV5vo7/giphy.gif)
*Kill switches: evaluated before any targeting rule — no network call, no context required*
...
![Progressive rollout — gradual traffic shift from 0% to 100%](https://media.giphy.com/media/3o7bu3XilJ5BOiSGic/giphy.gif)
*Meta's auto-ramp: 0.1% → 100% overnight, with automatic rollback on metric regression*
